const titles = ["Datura Daydreams", "Rise Like Water", "Morning After", "Fragile", "PVC Real Estate"]
const credits = ["directed by Jonah Garrett-Bannister", "directed by Jonah Garrett-Bannister", "directed by Saoirse D. Byrne", "directed by Laura Esteban", "directed by Holly Hunter"]
const briefPlot = ["Sam is bored of hookup culture, and while trying to find the balance between superficial appearance and genuine attraction he discovers an escape: an ugly thorned flower where he convinces himself the man of his dreams resides.", 
...
"A music video for the song Fragile by Noor Mandviwalla.", "A music video for the song PVC Real Estate by Shelf Lives."]
